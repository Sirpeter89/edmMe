...
export default function EventCardComponent({event}){
    ...
    let bookmarkBut;
    if(sessionUser && window.location.href !== 'https://edmme.herokuapp.com/bookmarks' && window.location.href !== 'https://edmme.herokuapp.com/myEvents' && event.userId !== sessionUser.id){
        bookmarkBut = (
